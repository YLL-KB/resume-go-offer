      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border-0 bg-gradient-to-r from-green-500 to-emerald-500 py-3.5 text-white font-medium transition-all duration-200 hover:from-green-400 hover:to-emerald-400 active:scale-[0.98] h-auto"
          ...
          <Button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border-gray-200 bg-white/70 backdrop-blur-xl py-3.5 text-slate-700 font-medium transition-all duration-200 hover:bg-white hover:border-gray-300 active:scale-[0.98] h-auto"
          >
