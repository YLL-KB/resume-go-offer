/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 844e152c5dc2cab3ab5021857faf3625)
// Runtime types generated with workerd@1.20260521.1 2026-05-26 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* resume-go-offer */;
	DB: D1Database;
	RESUME_GO_OFFER_KV: KVNamespace;
}
