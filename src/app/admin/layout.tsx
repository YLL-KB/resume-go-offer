...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="hidden md:flex w-52 shrink-0 flex-col border-r border-gray-200/60 bg-white/60 backdrop-blur-xl min-h-[calc(100vh-52px)] pt-4 px-3">
          <Link
            href="/admin"
            className="rounded-lg px-3 py-2 text-sm font-medium bg-emerald-50 text-emerald-700"
          >
            用户管理
          </Link>
        </aside>
